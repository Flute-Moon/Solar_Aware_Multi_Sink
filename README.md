...
No license file is currently included. If you intend to use, modify, or redistribute this code, please open an issue first and we'll add an appropriate license.
